      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-20 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-stone-500 max-w-2xl mx-auto mb-4 leading-relaxed">
            ...
            <a href="https://github.com/Zulqurnain/llmizeoff" className="text-orange-500 font-semibold hover:underline" target="_blank" rel="noopener noreferrer">
              llmizeOFF
            </a>
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-14">
            ...
            <a href="https://github.com/Zulqurnain/llmizeoff" target="_blank" rel="noopener noreferrer"
      ...
      <footer className="border-t border-stone-200 py-8 px-4 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex flex-wrap items-center gap-5 text-sm text-stone-400">
            <Link href="/" className="hover:text-stone-700 transition-colors">Chat</Link>
            ...
            <a href="https://github.com/Zulqurnain/llmizeoff" target="_blank" rel="noopener noreferrer" className="hover:text-stone-700 transition-colors">GitHub</a>
        ...
        <div className="max-w-5xl mx-auto mt-5 pt-5 border-t border-stone-100 text-center text-xs text-stone-400">
          ...
          {" "}· Runtime:{" "}
          <a href="https://github.com/Zulqurnain/llmizeoff" className="hover:text-stone-700">llmizeOFF</a>
        </div>
      </footer>
    </div>
  );
