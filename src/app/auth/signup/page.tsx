    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[#fafaf9]">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-stone-500 text-sm mt-1">Free forever · Powered by llmizeOFF</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs text-stone-400">
              <span className="bg-[#fafaf9] px-3">or sign up with email</span>
            </div>
          </div>
        ...
        <p className="text-center text-sm text-stone-500 mt-4">
          ...
          <Link href="/auth/login" className="text-orange-500 hover:underline font-medium">Sign in</Link>
        </p>
      </div>
    </div>
  );
